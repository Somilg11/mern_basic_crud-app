  ...
  return (
    <Box shadow='lg' rounded='lg' overflow='hidden' transition='all 0.3s' _hover={{transform: "translateY(-5px)", shadow: "xl"}} bg={bg}>
        ...
        <Box p={4}>
            ...
            <HStack spacing={2}>
                <IconButton icon={<MdModeEditOutline fontSize={20} />} colorScheme='blue' onClick={onOpen}/>
                <IconButton icon={<MdDelete fontSize={20} onClick={() => handleDeleteProduct(product._id)} />} colorScheme='red'/>
            </HStack>
        </Box>
        <Modal isOpen={isOpen} onClose={onClose}>
          ...
          <ModalContent>
            ...
            <Input placeholder='Price' name='price' type='number' value={updatedProduct.price} onChange={(e)=>setUpdateProduct({...updatedProduct, price: e.target.value})}/>
